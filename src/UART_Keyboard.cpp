/******************************************************************************
*  uart_keyboard.h
*  BC6xxx & BC759x UART Key Matrix Interface Driver Library
...
*    BC7595  --  48-key 6x8 matrix keyboard with 6 digits 7-segment LED display
*    BC7591  --  96-key 24x4 matrix keyboard with 32 digits 7-segment LED display
*
*  Dependencies:
...
******************************************************************************/
UartKeyboard::UartKeyboard(Stream& SerialPort)
    : Uart(SerialPort)
{
}
...
******************************************************************************/
bool UartKeyboard::isKeyChanged()
{
...
******************************************************************************/
uint8_t UartKeyboard::getKeyValue()
{
...
* Return Value: none
******************************************************************************/
void UartKeyboard::setDetectMode(const uint8_t Mode)
{
...
* Return Value: none
******************************************************************************/
void UartKeyboard::setLongpressCount(const uint16_t CountLimit)
{
...
* Return Value: none
******************************************************************************/
//void UartKeyboard::defCombinedKey(const uint8_t** pCBKeyList, uint8_t* pCBKeyMap, uint8_t CBKeyCount)
void UartKeyboard::defCombinedKey(const uint8_t** pCBKeyList, uint8_t CBKeyCount)
{
...
* Return Value: none
******************************************************************************/
void UartKeyboard::defLongpressKey(const uint8_t** pLPKeyList, uint8_t LPKeyCount)
{
...
* Return Value: none
******************************************************************************/
void UartKeyboard::setCallback(void (*pCallbackFunc)(uint8_t))
{
...
* Return Value: none
******************************************************************************/
void UartKeyboard::longpressTick()
{
    TimeCounter++;
...
* Return Value: none
******************************************************************************/
void UartKeyboard::checkChanges()
{
...
void UartKeyboard::updateKeyStatus(uint8_t RxData)
{
    uint8_t        i, j;
